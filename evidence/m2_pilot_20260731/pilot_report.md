...
> 工具 `aneb-campaign-analysis/1.0` · 生成 2026-08-01 01:08:54 +0800 · 读 12 行 → 保留 12 条（去重丢 0）。参数 {"min_samples": 5, "attr_kpi": "n1_rtt_p50_ms", "campaign": "m2-pilot-20260731", "before": null, "after": null}。
...
| 点位 | 运营商 | 时段 | 中位 | profile 跨度 | 分级 | n | 备注 |
|---|---|---|---|---|---|---|---|
| SZ-PILOT-01 | ctcc | busy | 13.24 | 10.05–16.43（2 个 profile） | good | 22 | RULED_OUT:s1_chat×11（D-366） |
| SZ-PILOT-01 | ctcc | idle | 14.12 | 11.18–17.07（2 个 profile） | good | 2 | RULED_OUT:s1_chat×1（D-366）; low_conf |
