...
BOOTTIME − MONOTONIC 偏移中位数 = 94513649503166 ns，跨度 = 1563 ns（n=5）。
...
| B screencap 帧差 | **不报时间误差**，只报采样周期 | 30 | — | 3353.600 | 7709.077 | 9974.079 | PASS |
...
通道 B 检出翻转 0 次（刺激源共翻 6 次）——检出率不是时序主张，只说明 ROI 与阈值选得对不对。
