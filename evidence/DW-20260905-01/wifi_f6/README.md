# wifi_f6 · DW-20260905-01（P2 两腿先行批，大脑自开窗）

- 条件：wifi；功能：F6 图像生成；提示词：`Generate an image of a red circle on a white background.`；轮数 6；答窗 75s ＋ 静置 20s（实际值见包级 `wifi_f6_driver_timing.jsonl` 逐轮）
