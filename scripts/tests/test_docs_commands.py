...
_D_REF_EXEMPT = {
    ...
    # D-705 已于 2026-09-05 被真实编号追上（A-6 通道 A 开回），示例号豁免撤销；**D-800 已于 2026-09-07 被追上**（笔② 两侧重叠 6.5%），本行同批撤销；**D-803 于 2026-09-07 同批被追上**（笔② 反事实框架），本行亦撤；**D-900 于 2026-09-12 被追上**（传递两端各自核那条），本行同批撤销——至此该提案里那组虚指示例号（D-700/705/800/803/900）**全部被真实编号追上、豁免清零**，此清单不再为「举例号」保留任何一行。
}
