...
> 🗄 **历史文档（2026-08-28 降级）**：本文是 v1.0 基线，**已被 [`REQUIREMENTS_BASELINE_v2.0.md`](REQUIREMENTS_BASELINE_v2.0.md) 取代为唯一现行需求源**。保留原样不删、不改写（留住「当时怎么规划的」记录）；本文里哪些话已不算数，见基线 §4 已知偏差表。
